...
public class ApprovalAdapter extends RecyclerView.Adapter<MyViewHolder2> {

    private Context context;
    private List<ApprovalClass> dataList;

    public ApprovalAdapter(Context context, List<ApprovalClass> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder2 holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, Admin_CG_Surveydetail.class );
