...
public class Admin_Client_Quote extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if(isConnected()){
                    ...
                    if(quote_CG.isEmpty()){
                        ...
                        ProgressDialog progressDialog = new ProgressDialog(Admin_Client_Quote.this);
                        ...
                        databaseReference.child("Quote").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if(snapshot.hasChild("caregiver")){
                                    ...
                                    Intent i = new Intent(Admin_Client_Quote.this, Admin_Client_Quote.class);
                                    startActivity(i);
                                    finish();
                                }else{
    ...
    {
        Intent i = new Intent(Admin_Client_Quote.this, DashboardActivity.class);
        startActivity(i);
        finish();
    }
}