...
public class Client_gigSetup extends AppCompatActivity {
...
//
//        final RadioGroup radiopref = findViewById(R.id.radiog);
...
//    }
    ...
    {
        Intent i = new Intent(Client_gigSetup.this, ClientDashBoardActivity.class);
        startActivity(i);
        finish();
    }
