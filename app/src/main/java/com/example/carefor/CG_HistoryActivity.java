...
public class CG_HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cghistory);
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(CG_HistoryActivity.this,1);
        RV.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(CG_HistoryActivity.this);
        ...
        adapter = new UserAdapter3(CG_HistoryActivity.this, datalist);
        RV.setAdapter(adapter);

        databaseReference.child("Caregiver").child(user).child("Accepted_Booking").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    {
        Intent i = new Intent(CG_HistoryActivity.this, CGDashBoardActivity.class);
        startActivity(i);
        finish();
    }
