...
public class UserAdapter3 extends RecyclerView.Adapter<MyViewHolder3>{

    private Context context;
    private List<BookingClass> dataList;

    public UserAdapter3(Context context, List<BookingClass> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder3 holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, CG_HistoryDetail.class );
