...
public class ClientSurvey extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ClientSurvey.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        SelectCNIC_Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(ClientSurvey.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    select_CNIC_pdf();
                } else {
                    ActivityCompat.requestPermissions(ClientSurvey.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 10);
                }
            }
        });
            ...
            public void onClick(View view) {
                if(isConnected()) {
                    ...
                    if (CNIC.isEmpty()) {
                        ...
                        Toast.makeText(ClientSurvey.this, "Please Select a CNIC File",Toast.LENGTH_SHORT).show();
                                    ...
                                    if (counter == 100) {
                                        ...
                                        databaseReference.child("Client").addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                ...
                                                Toast.makeText(ClientSurvey.this, "Details Received", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ClientSurvey.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
         ...
         if(requestCode ==10 && grantResults[0]==PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(ClientSurvey.this, "Please Provide Permission", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
         if(requestCode==87 && resultCode==RESULT_OK && data!=null){
            ...
            Toast.makeText(ClientSurvey.this,"Please Select a FIle",Toast.LENGTH_SHORT).show();
        }
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                       ...
                       // String url = taskSnapshot.getMetadata().getReference().getDownloadUrl().toString(); //returns url of file
                        databaseReference.child("Client").child(user).child("CNIC_Doc").setValue(url1).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(ClientSurvey.this,"File Uploaded Successfully",Toast.LENGTH_SHORT);
                                    progressDialog.dismiss();
                                }else{
                                    Toast.makeText(ClientSurvey.this,"File Not Uploaded",Toast.LENGTH_SHORT);
                                }
                            }
                        });
