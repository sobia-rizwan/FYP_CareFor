...
public class CG_HistoryDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cg_history_detail);
        ...
        start_job = findViewById(R.id.start12);
        ...
        BackBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(CG_HistoryDetail.this, CG_HistoryActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        start_job.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(detailStatus.getText().toString().equals("Ongoing")){
                    Toast.makeText(getApplicationContext(), "Job started already", Toast.LENGTH_LONG).show();
                    Toast.makeText(getApplicationContext(), "Client will stop", Toast.LENGTH_LONG).show();

                }else if(detailStatus.getText().toString().equals("Completed")){
                    Toast.makeText(getApplicationContext(), "Job Completed", Toast.LENGTH_LONG).show();
                }else{
                    AlertDialog.Builder builder = new AlertDialog.Builder(CG_HistoryDetail.this);
                            ...
                            .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    databaseReference.child("Caregiver").addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            databaseReference.child("Caregiver").child(user).child("Accepted_Booking").child(detailTitle.getText().toString()).child("Booking_Status").setValue("Ongoing");
                                        }
                                    ...
                                    databaseReference.child("Client").addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            databaseReference.child("Client").child(detailTitle.getText().toString()).child("Accepted_Booking").child(user).child("Booking_Status").setValue("Ongoing");
                                    ...
                                    databaseReference.child("Booking").addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            databaseReference.child("Booking").child(s).child("Booking_Status").setValue("Ongoing");
                                        }
                                    ...
                                    Intent i1 = new Intent(CG_HistoryDetail.this, CGDashBoardActivity.class);
                                    startActivity(i1);
                                }
                            })
